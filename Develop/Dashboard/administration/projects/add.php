...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    save($mysqli, $codeProject, $titleProject, $nameProject, $resumeProject, $impactProject, $impactLocationProject,$expectedResultsProject, $dateStartProject, $dateEndProject, $investigationLineProject, $statusProject, $keywordsProject, $investigationgroupProject, $seedbedProject);
