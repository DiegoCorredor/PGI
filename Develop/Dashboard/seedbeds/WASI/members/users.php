                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 bg-white rounded mb-4 pl-4 mx-2">
                            <p class="h2 text-gray-800 pt-3">Integrantes del semillero</p><hr>
                            <table class="table table-hover ">
                                <thead class="thead-dark text-center">
                                    <tr>
                                        ...
                                        <th scope="col">DNI</th>
                                        <th scope="col">Código UPTC</th>
                                        <th scope="col">Teléfono</th>
                                        <th scope="col">Correo UPTC</th>
                                ...
                                <?php
                                    require '../../../conn.php';
                                    require_once '../../../controller/viewMembers.php';
                                    viewUser($mysqli,1);
                                ?>
                                </tbody>
                            </table>
