                    ...
                    echo "<div id='collapseTwo' class='collapse' aria-labelledby='headingTwo' data-parent='#accordionSidebar'>
                            ...
                            <div id='collapseThree' class='collapse' aria-labelledby='headingThree' data-parent='#collapseTwo'>
                                <div class='bg-white py-2 collapse-inner rounded'>
                                    <a class='collapse-item' href='./seedbeds/".$row['alias']."/info'><i class='fas fa-fw fa-info'></i>  -  Información</a>
                                    <a class='collapse-item' href='./seedbeds/".$row['alias']."/members'><i class='fas fa-fw fa-user'></i>  -  Integrantes</a>
                                    <a class='collapse-item' href='./seedbeds/".$row['alias']."/projects'><i class='fas fa-fw fa-folder'></i>  -  Proyectos</a>
                                </div>
                            </div>
                        </div>";
                }
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Dashboard de <?php echo $nombre; ?></h1>
